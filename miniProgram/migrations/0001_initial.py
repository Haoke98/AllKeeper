    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_name', models.CharField(blank=True, default='#', max_length=600, verbose_name='文件名')),
                ('original_url', models.CharField(blank=True, default='#', max_length=500, verbose_name='原始链接（公众号）')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover', models.ForeignKey(blank=True, default=4, on_delete=django.db.models.deletion.DO_NOTHING, to='miniProgram.image')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('app_id', models.CharField(max_length=18)),
                ('app_secret', models.CharField(max_length=32)),
                ('enableVIP_mode', models.BooleanField(default=False, verbose_name='是否启动VIP模式')),
                ...
                ('host', models.URLField(blank=True, null=True, verbose_name='服务器运行的地址')),
